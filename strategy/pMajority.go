...
var MajorityStrategy = *NewPlatformStrategy("Majority", pMajority)

func pMajority(watchHistory map[string]int, watchHistory2 map[string]int, watchHistory3 map[string]int, budget float32, catalog *utils.SynchronizedCatalog, store *utils.SynchronizedCatalog) {
